 ...
 *
 */
public class OutcomeContractWithoutTreeFragment extends Fragment {
	...
	public void handleArguments() {
		...
		if (bundle != null) {
			...
			if (bundle.containsKey(ListSelectActivity.PARENT_BEAN_KEY)) {
				mContractType = bundle.getString(ListSelectActivity.PARENT_BEAN_KEY);
			}
		}
	}
	...
	ServiceInterface<Contract> listServiceInterface 
		...
		public void getListData() {
			mExpensesContractService.getExpensesContractList(new DataManagerInterface() {
						...
						case AnalysisManager.SUCCESS_DB_QUERY:
							...
							if (mContractType != null) {
								for (int i = 0; i < mContractList.size(); i++) {
									if (!mContractType.equals(mContractList
											.get(i).getType() + "")) {
	...
	private void getContractTotalChanges() {
		...
		mExpensesContractService.getExpensesContractByToatlChanges(new DataManagerInterface() {
	...
	private void getContractTotalPaid() {
		...
		mExpensesContractService.getExpensesContractByToatlPaid(new DataManagerInterface() {

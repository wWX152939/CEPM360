...
public class EquipmentFragment extends BaseTreeContentFragment<P_WZ_DIR, P_WZ> {
	// 树和内容远程服务
	...
	void prepareEnvironment() {
		...
		String[][] typeStrings =  GLOBAL.SB_TYPE;
		// 为物资类型（材料或设备）做映射
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mTreeListTitle.setText(R.string.equipment_category);
	...
	ServiceInterface<P_WZ_DIR> treeServiceInterface = new ServiceInterface<P_WZ_DIR>() {
		...
		public void addItem(P_WZ_DIR t) {
			if (t != null) {
				...
				t.setWz_type_1(Integer.parseInt(GLOBAL.WBS_TYPE[1][0]));
			} else {
				t = new P_WZ_DIR();
				t.setP_wz_dir_id(0);
				t.setWz_dir_id(1);
				t.setName(getResources().getString(R.string.all_equipment));
				t.setWz_type_1(Integer.parseInt(GLOBAL.WBS_TYPE[1][0]));
			}
	...
	SimpleDialogInterface treeDialogInterface = new SimpleDialogInterface() {
		...
		public int getDialogTitleId() {
			return R.string.add_modify_equipment_type;
		}
	...
	CommonListInterface<P_WZ> contentCommonListInterface = new CommonListInterface<P_WZ>() {
		...
		public int getListHeaderNames() {
			return R.array.equipment_content_header_names;
		}
	...
	DialogAdapterInterface contentDialogAdapterInterface = new DialogAdapterInterface() {
		...
		@Override
		public int getDialogTitleId() {
			return R.string.add_modify_equipment;
		}
		...
		public Map<Integer, String[]> getSupplyData() {
			...
			String[][] typeArray = GLOBAL.SB_TYPE;

...
public class SubcontractManagerAddActivity extends ActionBarFragmentActivity
	...
	public final static String MSG_SUBCONTRACT_MANAGEMENT_ACTION = "com.pm360.cepm360.action.subcontract_manager";
	// 列表头显示名称
	...
	private void msgHandlerProgress() {
		...
		if (action != null && action.equals(MSG_SUBCONTRACT_MANAGEMENT_ACTION)) {
		...
		exe_contractET.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(v.getContext(),
						/*ContractSelectActivity.class*/null);

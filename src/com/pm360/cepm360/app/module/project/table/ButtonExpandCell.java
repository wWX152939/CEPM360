...
public class ButtonExpandCell extends ExpandCell {

    public static final int DEFAULT_WIDTH = 48;
    private int mResId;
    private View.OnClickListener mListener;

    public ButtonExpandCell(String cellValue, String head, int width, int expandId, int parentId,
            boolean isFolder, int resId) {
        super(cellValue, head, width, expandId, parentId, isFolder);
        mResId = resId;
    }
    ...
    public View createView(ViewGroup parent, int rowId, boolean isFolder, int textColor) {
        ...
        child.setPadding(20 * getLevel(), 0, 0, 0);

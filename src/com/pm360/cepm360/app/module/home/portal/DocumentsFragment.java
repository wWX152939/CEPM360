...
public class DocumentsFragment extends Fragment {
    ...
    private DataListAdapter<Files> mAdapter;
    private List<Files> mDataList = new ArrayList<Files>();
    ...
    private void loadData() {
        ...
        RemoteIndexService.getInstance().getMoreDocumentList(new DataManagerInterface() {
            ...
            public void getDataOnResult(ResultStatus status, List<?> list) {
                ...
                if (status.getCode() == AnalysisManager.SUCCESS_DB_QUERY) {
                    if (list != null && list.size() > 0) {
                        mDataList.addAll((ArrayList<Files>) list);                        
                    }
                }                
    ...
    private void doQuery(Index_document bean) {
        User user = UserCache.getCurrentUser();
        bean.setTenant_id(user.getTenant_id());
        bean.setUser_id(user.getUser_id());
        mActivity.showProgressDialog("MyTask doQuery...");
        RemoteIndexService.getInstance().getDocumentListByCondition(new DataManagerInterface() {
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                case R.id.button_query:
                    Index_document bean = new Index_document();
    ...
    private void initContentView(View view) {
        ...
        mAdapter = new DataListAdapter<Files>(mActivity, adapterManager, mDataList);
        mListView.setAdapter(mAdapter);
    }
    
    private ListAdapterInterface<Files> adapterManager = new DataListAdapter.ListAdapterInterface<Files>() {
            ...
            for (int i = 0; i < viewHolder.tvs.length; i++) {
                viewHolder.tvs[i].setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        IntentHelper.openFile(getActivity(), mDataList.get(position));
                    }
                });
            }
        }
        ...
        private Map<String, String> beanToMap(Files data, int position) {
            Map<String, String> mapItem = new HashMap<String, String>();  
            mapItem.put(mHeaderNames[0], String.valueOf(position + 1));
            mapItem.put(mHeaderNames[1], data.getTitle());
            mapItem.put(mHeaderNames[2], DateUtils.dateToString(DateUtils.FORMAT_LONG, data.getCreate_time()));
            return mapItem;
        }

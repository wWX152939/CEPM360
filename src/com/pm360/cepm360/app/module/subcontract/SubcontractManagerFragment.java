...
public class SubcontractManagerFragment extends Fragment implements
	...
	private static final String SUBCONTRACT_VIEW = "4_2";
	private static final String SUBCONTRACT_EDIT = "4_1";
    ...
    private void loadData() {
        RemoteSubCcontentService.getInstance().getWBRGList(
                mManager,
                UserCache.getCurrentUser().getTenant_id(),
                0,
		...
		for (int i = 0; i < viewHolder.tvs.length; i++) {
			if (i == 2) {
				...
				if (htName != null && !htName.equals("")) {
					...
					viewHolder.tvs[i].setCompoundDrawables(null, null,
							drawable, null);
	...
	public void onResume() {
		...
		if (mCurrentProject == null) {
			if (ProjectCache.getCurrentProject() != null) {
				...
				((SubcontractManagementActivity) getActivity())

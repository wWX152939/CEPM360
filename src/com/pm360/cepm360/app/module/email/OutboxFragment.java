...
public class OutboxFragment extends EmailFragment<MailBox> {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		init(MailBox.class, mListInterface, mServiceInterface, null, null, EMAIL_OUTBOX);
	...
	MailServiceInterface mServiceInterface = new MailServiceInterface() {
		...
		public void getListData() {
			mService.getOutbox(getServiceHandler(),
		...
		public void deleteItem(MailBox t) {
			t.setDel_out(GLOBAL.MSG_DEL[1][0]);
			mService.deleteOutboxMail(getServiceHandler(), t.getMail_box_id(), t.getDel_out());
		}

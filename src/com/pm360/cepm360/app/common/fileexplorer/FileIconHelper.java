...
import com.pm360.cepm360.app.common.fileexplorer.FileCategoryHelper.FileCategory;
import com.pm360.cepm360.app.common.fileexplorer.FileIconLoader.IconLoadFinishListener;
...
//                break;
            ...
            case Video:
                ...
                if (set)
                    ...
                    fileImage.setImageResource(fc == FileCategory.Picture ? R.drawable.file_documents_picture
                            : R.drawable.file_icon_video);
        ...
        if (!set) {
            fileImage.setImageResource(R.drawable.file_documents_other);
        } 
    }

...
package com.pm360.cepm360.app.common.lockpattern.util;
...
public class ResourceUtils {
    ...
    /**
     * Convenient method for {@link Context#getTheme()} and {@link Resources.Theme#resolveAttribute(int, TypedValue,
     * boolean)}.
     *
     ...
     */
    public static int resolveAttribute(Context context, int resId, int defaultValue) {

...
import com.pm360.cepm360.app.common.lockpattern.util.FloatAnimator;
...
public class LockPatternView extends View {
    ...
    private void drawCircle(Canvas canvas, float centerX, float centerY,
        ...
        mBigPaint.setAlpha((int) (alpha * 255));
        mBigPaint.setColor(Color.WHITE);        
        mBigPaint.setStyle(Style.STROKE);
        mBigPaint.setStrokeWidth(2);
        canvas.drawCircle(centerX, centerY, size * 2, mBigPaint);

        mPaint.setAntiAlias(true);
        mPaint.setColor(Color.WHITE);
        mPaint.setAlpha((int) (alpha * 255));
        canvas.drawCircle(centerX, centerY, (size / 2) + 2, mPaint);        

...
public class SimpleList<T extends Serializable> extends BaseListCommon<T>
	...
	protected DataListAdapter<T> mListAdapter;	// 适配器adapter定义
	...
	protected void initLayout() {
		...
		if (mLocationImpl == null) {
			mRootLayout = mInflater.inflate(R.layout.list_layout, null);
		} else {
...
//		mListHeader.findViewById(R.id.slide_flage_line).setVisibility(View.GONE);
	...
	private void setListAdapter() {
		...
		// 初始化适配器并与内容列表视图控件绑定
		mListAdapter = new DataListAdapter<T>(mContext, mListAdapterImplement, mListImplement.getListHeaderIds());

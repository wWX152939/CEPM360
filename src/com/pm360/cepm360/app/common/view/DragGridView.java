...
public class DragGridView extends GridView{
	...
	private Runnable mLongClickRunnable = new Runnable() {
		...
		@Override
		public void run() {
			Log.v("chenchen","mLongClickRunnable");
			isDrag = true; //设置可以拖拽
			...
			mDeleteView = onLongPressListener.setDeleteView();
			mModifyView = onLongPressListener.setModifyView();			
		}
	};
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			Log.v("chenchen","mDownX="+mDownX+",mDownY="+mDownY);
...
//			ImageView arrImageView = (ImageView)mStartDragItemView.findViewById(R.id.gridview_arr_image);
//			if (arrImageView.getVisibility() == View.VISIBLE){
...
//			Log.v("chenchen","moveX="+moveX+",moveY="+moveY);
		...
		case MotionEvent.ACTION_UP:
			...
			if (isDrag == true && inRangeOfView(mDeleteView, ev)) {
			...
			} else if (isDrag == true && inRangeOfView(mModifyView, ev)) {
				onChanageListener.onModify(mDragPosition);
			}
			mHandler.removeCallbacks(mLongClickRunnable);
	...
	private boolean inRangeOfView(View view, MotionEvent ev){
		...
		int x = location[0];
		int y = location[1];
		Log.v("chenchen","inRangeOfView ev.getRawX()="+ev.getRawX()+",ev.getRawY()="+ev.getRawY());
		Log.v("chenchen","inRangeOfView x ="+x+",y = "+y);
	...
	private Runnable mScrollRunnable = new Runnable() {
		...
		@Override
		public void run() {
//			Log.v("chenchen","mScrollRunnable");
			int scrollY;
...
//		Log.v("chenchen","onSwapItem");
	...
	public interface OnLongPressListener{	
		 ...
		 * 			拖拽到的position
		 */
		public void OnLongPress(boolean flag);
		public TextView setModifyView();
		public TextView setDeleteView();
	}	
}

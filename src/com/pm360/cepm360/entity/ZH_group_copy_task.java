...
public class ZH_group_copy_task implements Serializable {
	...
	return "ZH_group_copy_task [task_id=" + task_id + ", zh_group_id=" + zh_group_id + ", code=" + code + ", name=" + name + ", start_time="
	        ...
	        + feedback_creater + ", wbs_id=" + wbs_id + ", has_child=" + has_child + ", level=" + level + ", expanded=" + expanded

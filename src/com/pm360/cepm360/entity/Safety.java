 ...
 * 
 */
public class Safety extends AttachWaterMarkCell {
    ...
    public void setSafety_id(int safety_id) {
	...
	return "Safety [safety_id=" + safety_id + ", project_id=" + project_id + ", zh_group_id=" + zh_group_id + ", task_id=" + task_id + ", name="
	        + name + ", type=" + type + ", content=" + content + ", event_date=" + event_date + ", create_date=" + create_date + ", tenant_id="
	        + tenant_id + ", attachment=" + attachment + ", msg_user=" + msg_user + "]";
    }

    @Override
    public String getTypeName() {
	int id = type == 0 ? 1 : type;
	return GLOBAL.SAFETY_TYPE[id - 1][1];
    }
}

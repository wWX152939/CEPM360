...
public class ZH_group_task extends TaskCell implements Serializable {
	...
	return "ZH_group_task [task_id=" + task_id + ", zh_group_id=" + zh_group_id + ", code=" + code + ", name=" + name + ", start_time="
	        + start_time + ", end_time=" + end_time + ", actual_start_time=" + actual_start_time + ", actual_end_time=" + actual_end_time
	        + ", owner=" + owner + ", type=" + type + ", status=" + status + ", progress=" + progress + ", plan_duration=" + plan_duration
	        + ", actual_duration=" + actual_duration + ", cc_user=" + cc_user + ", department=" + department + ", parents_id=" + parents_id
	        + ", creater=" + creater + ", create_time=" + create_time + ", publish=" + publish + ", mark=" + mark + ", feedback_creater="
	        + feedback_creater + ", templet_wbs_dir_id=" + templet_wbs_dir_id + ", has_child=" + has_child + ", level=" + level + ", expanded="
	        + expanded + ", change_id=" + change_id + ", pk=" + pk + ", tenant_id=" + tenant_id + ", sort=" + sort + "]";
    }
